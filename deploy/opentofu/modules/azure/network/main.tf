...
output "id" { value = azapi_resource.network.id }
output "apps_subnet_id" { value = "${azapi_resource.network.id}/subnets/apps" }
output "endpoints_subnet_id" { value = "${azapi_resource.network.id}/subnets/endpoints" }
output "database_subnet_id" { value = var.postgres_enabled ? "${azapi_resource.network.id}/subnets/database" : null }
